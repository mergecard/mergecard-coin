...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MergeCard server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MergeCard server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MergeCard features */
        {"mergecard", "masternode", &masternode, true, true, false},
        {"mergecard", "listmasternodes", &listmasternodes, true, true, false},
        {"mergecard", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mergecard", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mergecard", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mergecard", "masternodedebug", &masternodedebug, true, true, false},
        {"mergecard", "startmasternode", &startmasternode, true, true, false},
        {"mergecard", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mergecard", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mergecard", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mergecard", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mergecard", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mergecard", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mergecard", "mnbudget", &mnbudget, true, true, false},
        {"mergecard", "preparebudget", &preparebudget, true, true, false},
        {"mergecard", "submitbudget", &submitbudget, true, true, false},
        {"mergecard", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mergecard", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mergecard", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mergecard", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mergecard", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mergecard", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mergecard", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mergecard", "checkbudgets", &checkbudgets, true, true, false},
        {"mergecard", "mnsync", &mnsync, true, true, false},
        {"mergecard", "spork", &spork, true, true, false},
        {"mergecard", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mergecard", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mergecardd, or the -server option to mergecard-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mergecard-cli " + methodname + " " + args + "\n";
}
