...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MergeCard Core mergecard-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mergecard-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mergecard transaction") + "\n" +
                               "  mergecard-tx [options] -create [commands]   " + _("Create hex-encoded mergecard transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mergecard transaction
