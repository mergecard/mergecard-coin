...
/** 
    ...
    ****Note - for MergeCard we using fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of mergecard coming in to a transaction
