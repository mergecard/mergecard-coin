...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MRG:
        return QString("mergecard");
    case mMRG:
        return QString("mmergecard");
    case uMRG:
        return QString::fromUtf8("umergecard");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MRG:
            return QString("tMRG");
        case mMRG:
            return QString("mtMRG");
        case uMRG:
            return QString::fromUtf8("μtMRG");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MRG:
            return QString("MRG");
        case mMRG:
            return QString("Milli-MRG (1 / 1" THIN_SP_UTF8 "000)");
        case uMRG:
            return QString("Micro-MRG (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MRG:
            return QString("TestMRGs");
        case mMRG:
            return QString("Milli-TestMRG (1 / 1" THIN_SP_UTF8 "000)");
        case uMRG:
            return QString("Micro-TestMRG (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
