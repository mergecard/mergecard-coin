...
QT_MOC_LITERAL(8, 67, 7), // "pubCoin"
QT_MOC_LITERAL(9, 75, 6) // "isUsed"

    },
    "AddressTableModel\0updateEntry\0\0address\0"
    "label\0isMine\0purpose\0status\0pubCoin\0"
    "isUsed"
};
...
void AddressTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateEntry((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    }
}
