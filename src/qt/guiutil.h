...
/** Utility functions used by the MergeCard Qt UI.
 */
namespace GUIUtil
{
...
// Render MergeCard addresses in monospace font
...
// Parse "mergecard:" URI into recipient object, return true on successful parsing
