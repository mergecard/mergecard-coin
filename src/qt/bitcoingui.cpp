                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MergeCard Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    labelConnectionsIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); border:0;}");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MergeCard address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mergecard: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMRG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MergeCard Core"), this);
    aboutAction->setStatusTip(tr("Show information about MergeCard Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MergeCard"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MergeCard addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MergeCard addresses"));
    ...
    openAction->setStatusTip(tr("Open a MergeCard: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MergeCard Core help message to get a list with possible MergeCard command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MergeCard Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MergeCard network", "", count));
}
...
{
    QString strTitle = tr("MergeCard Core"); // default title
