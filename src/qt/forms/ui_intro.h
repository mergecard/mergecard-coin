...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to MergeCard Core.", nullptr));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where MergeCard Core will store its data.", nullptr));
        sizeWarningLabel->setText(QApplication::translate("Intro", "MergeCard Core will download and store a copy of the MergeCard block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", nullptr));
