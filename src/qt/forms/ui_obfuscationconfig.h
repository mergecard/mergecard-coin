...
public:
    ...
    {
        ObfuscationConfig->setWindowTitle(QApplication::translate("ObfuscationConfig", "Configure Obfuscation", nullptr));
        buttonBasic->setText(QApplication::translate("ObfuscationConfig", "Basic Privacy", nullptr));
        buttonHigh->setText(QApplication::translate("ObfuscationConfig", "High Privacy", nullptr));
        buttonMax->setText(QApplication::translate("ObfuscationConfig", "Maximum Privacy", nullptr));
        label->setText(QApplication::translate("ObfuscationConfig", "Please select a privacy level.", nullptr));
        label_2->setText(QApplication::translate("ObfuscationConfig", "Use 2 separate masternodes to mix funds up to 10000 MRG", nullptr));
        label_3->setText(QApplication::translate("ObfuscationConfig", "Use 8 separate masternodes to mix funds up to 10000 MRG", nullptr));
        label_4->setText(QApplication::translate("ObfuscationConfig", "Use 16 separate masternodes", nullptr));
        label_6->setText(QApplication::translate("ObfuscationConfig", "This option is the quickest and will cost about ~0.025 MRG to anonymize 10000 MRG", nullptr));
        label_7->setText(QApplication::translate("ObfuscationConfig", "This option is moderately fast and will cost about 0.05 MRG to anonymize 10000 MRG", nullptr));
        label_8->setText(QApplication::translate("ObfuscationConfig", "This is the slowest and most secure option. Using maximum anonymity will cost", nullptr));
        label_9->setText(QApplication::translate("ObfuscationConfig", "0.1 MRG per 10000 MRG you anonymize.", nullptr));
    } // retranslateUi
