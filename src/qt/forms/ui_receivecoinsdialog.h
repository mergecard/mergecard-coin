...
public:
    ...
    void setupUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        ReceiveCoinsDialog->resize(776, 415);
    ...
    void retranslateUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        reuseAddress->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Reuse one of the previously used receiving addresses.<br>Reusing addresses has security and privacy issues.<br>Do not use this unless re-generating a payment request made before.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the MergeCard network.", nullptr));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        reqLabel->setPlaceholderText(QApplication::translate("ReceiveCoinsDialog", "Enter a label for this request here", nullptr));
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened.<br>Note: The message will not be sent with the payment over the MergeCard network.", nullptr));
#endif // QT_NO_TOOLTIP
        reqMessage->setPlaceholderText(QApplication::translate("ReceiveCoinsDialog", "Enter your message (optional)", nullptr));
