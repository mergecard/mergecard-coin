...
public:
    ...
    {
        Bip38ToolDialog->setWindowTitle(QApplication::translate("Bip38ToolDialog", "BIP 38 Tool", nullptr));
        infoLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Enter a MergeCard Address that you would like to encrypt using BIP 38. Enter a passphrase in the middle box. Press encrypt to compute the encrypted private key.", nullptr));
        label_5->setText(QApplication::translate("Bip38ToolDialog", "Address:", nullptr));
#ifndef QT_NO_TOOLTIP
        addressIn_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "The MergeCard address to sign the message with", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        addressBookButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Choose previously used address", nullptr));
#endif // QT_NO_TOOLTIP
        addressBookButton_ENC->setText(QString());
#ifndef QT_NO_SHORTCUT
        addressBookButton_ENC->setShortcut(QApplication::translate("Bip38ToolDialog", "Alt+A", nullptr));
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        pasteButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Paste address from clipboard", nullptr));
#endif // QT_NO_TOOLTIP
        pasteButton_ENC->setText(QString());
#ifndef QT_NO_SHORTCUT
        pasteButton_ENC->setShortcut(QApplication::translate("Bip38ToolDialog", "Alt+P", nullptr));
#endif // QT_NO_SHORTCUT
        label_6->setText(QApplication::translate("Bip38ToolDialog", "Passphrase: ", nullptr));
        encryptedKeyLabel_ENC->setText(QApplication::translate("Bip38ToolDialog", "Encrypted Key:", nullptr));
#ifndef QT_NO_TOOLTIP
        copyKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Copy the current signature to the system clipboard", nullptr));
#endif // QT_NO_TOOLTIP
        copyKeyButton_ENC->setText(QString());
#ifndef QT_NO_TOOLTIP
        encryptKeyButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Sign the message to prove you own this MergeCard address", nullptr));
#endif // QT_NO_TOOLTIP
        encryptKeyButton_ENC->setText(QApplication::translate("Bip38ToolDialog", "Encrypt &Key", nullptr));
#ifndef QT_NO_TOOLTIP
        clearButton_ENC->setToolTip(QApplication::translate("Bip38ToolDialog", "Reset all sign message fields", nullptr));
#endif // QT_NO_TOOLTIP
        clearButton_ENC->setText(QApplication::translate("Bip38ToolDialog", "Clear &All", nullptr));
        statusLabel_ENC->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tabBip38Encrypt), QApplication::translate("Bip38ToolDialog", "&BIP 38 Encrypt", nullptr));
        infoLabel_DEC->setText(QApplication::translate("Bip38ToolDialog", "Enter the BIP 38 encrypted private key. Enter the passphrase in the middle box. Click Decrypt Key to compute the private key. After the key is decrypted, clicking 'Import Address' will add this private key to the wallet.", nullptr));
        label_2->setText(QApplication::translate("Bip38ToolDialog", "Encrypted Key:", nullptr));
#ifndef QT_NO_TOOLTIP
        encryptedKeyIn_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "The MergeCard address the message was signed with", nullptr));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("Bip38ToolDialog", "Passphrase: ", nullptr));
#ifndef QT_NO_TOOLTIP
        decryptKeyButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Verify the message to ensure it was signed with the specified MergeCard address", nullptr));
#endif // QT_NO_TOOLTIP
        decryptKeyButton_DEC->setText(QApplication::translate("Bip38ToolDialog", "Decrypt &Key", nullptr));
#ifndef QT_NO_TOOLTIP
        clearButton_DEC->setToolTip(QApplication::translate("Bip38ToolDialog", "Reset all verify message fields", nullptr));
#endif // QT_NO_TOOLTIP
        clearButton_DEC->setText(QApplication::translate("Bip38ToolDialog", "Clear &All", nullptr));
        statusLabel_DEC->setText(QString());
        label_3->setText(QApplication::translate("Bip38ToolDialog", "Decrypted Key:", nullptr));
        importAddressButton_DEC->setText(QApplication::translate("Bip38ToolDialog", "Import Address", nullptr));
        label_4->setText(QApplication::translate("Bip38ToolDialog", "Address:", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabBip38Decrypt), QApplication::translate("Bip38ToolDialog", "&BIP 38 Decrypt", nullptr));
    } // retranslateUi
