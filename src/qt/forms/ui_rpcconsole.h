...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        lblBytesIn = new QLabel(tab_nettraffic);
        ...
        lblBytesOut = new QLabel(tab_nettraffic);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        generalHeader->setText(QApplication::translate("RPCConsole", "General", nullptr));
        clientNameLabel->setText(QApplication::translate("RPCConsole", "Client name", nullptr));
        clientName->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        clientVersionLabel->setText(QApplication::translate("RPCConsole", "Client version", nullptr));
        clientVersion->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        openSSLVersionLabel->setText(QApplication::translate("RPCConsole", "Using OpenSSL version", nullptr));
        openSSLVersion->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        berkeleyDBVersionLabel->setText(QApplication::translate("RPCConsole", "Using BerkeleyDB version", nullptr));
        berkeleyDBVersion->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        buildDateLabel->setText(QApplication::translate("RPCConsole", "Build date", nullptr));
        buildDate->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        startupTimeLabel->setText(QApplication::translate("RPCConsole", "Startup time", nullptr));
        startupTime->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        networkHeader->setText(QApplication::translate("RPCConsole", "Network", nullptr));
        networkNameLabel->setText(QApplication::translate("RPCConsole", "Name", nullptr));
        networkName->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        numberOfConnectionsLabel->setText(QApplication::translate("RPCConsole", "Number of connections", nullptr));
        ...
        blockchainHeader->setText(QApplication::translate("RPCConsole", "Block chain", nullptr));
        numberOfBlocksLabel->setText(QApplication::translate("RPCConsole", "Current number of blocks", nullptr));
        numberOfBlocks->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        lastBlockTimeLabel->setText(QApplication::translate("RPCConsole", "Last block time", nullptr));
        lastBlockTime->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        debugLogFileHeader->setText(QApplication::translate("RPCConsole", "Debug log file", nullptr));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the MergeCard debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        label_21->setText(QApplication::translate("RPCConsole", "Protocol", nullptr));
        peerVersion->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        label_28->setText(QApplication::translate("RPCConsole", "Version", nullptr));
        ...
        btn_resync->setText(QApplication::translate("RPCConsole", "Delete local Blockchain Folders", nullptr));
        ...
        wallet_path_label->setText(QApplication::translate("RPCConsole", "Wallet In Use:", nullptr));
        ...
        label_repair_salvage->setText(QApplication::translate("RPCConsole", "Attempt to recover private keys from a corrupt wallet.dat.", nullptr));
        btn_rescan->setText(QApplication::translate("RPCConsole", "Rescan blockchain files", nullptr));
        label_repair_rescan->setText(QApplication::translate("RPCConsole", "Rescan the block chain for missing wallet transactions.", nullptr));
        btn_zapwallettxes1->setText(QApplication::translate("RPCConsole", "Recover transactions 1", nullptr));
        label_repair_zap1->setText(QApplication::translate("RPCConsole", "Recover transactions from blockchain (keep meta-data, e.g. account owner).", nullptr));
        btn_zapwallettxes2->setText(QApplication::translate("RPCConsole", "Recover transactions 2", nullptr));
        label_repair_zap2->setText(QApplication::translate("RPCConsole", "Recover transactions from blockchain (drop meta-data).", nullptr));
        btn_upgradewallet->setText(QApplication::translate("RPCConsole", "Upgrade wallet format", nullptr));
        label_repair_upgrade->setText(QApplication::translate("RPCConsole", "Upgrade wallet to latest format on startup. (Note: this is NOT an update of the wallet itself!)", nullptr));
        btn_reindex->setText(QApplication::translate("RPCConsole", "Rebuild index", nullptr));
        label_repair_reindex->setText(QApplication::translate("RPCConsole", "Rebuild block chain index from current blk000??.dat files.", nullptr));
        label_repair_resync_command->setText(QApplication::translate("RPCConsole", "-resync:", nullptr));
        label_repair_resync->setText(QApplication::translate("RPCConsole", "Deletes all local blockchain folders so the wallet synchronizes from scratch.", nullptr));
