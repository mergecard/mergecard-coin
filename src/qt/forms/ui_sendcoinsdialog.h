...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MRG"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MRG"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 113));
        ...
        checkzMRG = new QCheckBox(SendCoinsDialog);
        checkzMRG->setObjectName(QStringLiteral("checkzMRG"));
        checkzMRG->setEnabled(false);

        horizontalLayout_2->addWidget(checkzMRG);
        ...
        labelBalance->setText(QStringLiteral("123.456 MRG"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        pushButtonCoinControl->setText(QApplication::translate("SendCoinsDialog", "Open Coin Control...", nullptr));
        labelCoinControlAutomaticallySelected->setText(QApplication::translate("SendCoinsDialog", "Coins automatically selected", nullptr));
        ...
        splitBlockCheckBox->setText(QApplication::translate("SendCoinsDialog", "Split UTXO", nullptr));
        splitBlockLineEdit->setPlaceholderText(QApplication::translate("SendCoinsDialog", "# of outputs", nullptr));
        labelBlockSizeText->setText(QApplication::translate("SendCoinsDialog", "UTXO Size:", nullptr));
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 MRG", nullptr));
...
#endif // QT_NO_TOOLTIP
        buttonMinimizeFee->setText(QApplication::translate("SendCoinsDialog", "Minimize", nullptr));
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uMRGs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uMRGs in fee,<br />while \"at least\" pays 1000 uMRGs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", nullptr));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uMRGs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uMRGs in fee,<br />while \"total at least\" pays 1000 uMRGs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for MergeCard transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for MergeCard transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        labelMinFeeWarning->setText(QApplication::translate("SendCoinsDialog", "(read the tooltip)", nullptr));
        radioCustomFee->setText(QString());
        labelSmartFee3->setText(QApplication::translate("SendCoinsDialog", "Confirmation time:", nullptr));
        ...
        labelSmartFee_2->setText(QApplication::translate("SendCoinsDialog", "Recommended", nullptr));
        radioSmartFee->setText(QString());
        labelCustomFee->setText(QApplication::translate("SendCoinsDialog", "Custom:", nullptr));
        ...
        checkBoxFreeTx->setText(QApplication::translate("SendCoinsDialog", "Send as zero-fee transaction if possible", nullptr));
        labelFreeTx->setText(QApplication::translate("SendCoinsDialog", "(confirmation may take longer)", nullptr));
#ifndef QT_NO_TOOLTIP
        ...
        checkzMRG->setText(QApplication::translate("SendCoinsDialog", "Anonymized MRG", nullptr));
        checkSwiftTX->setText(QApplication::translate("SendCoinsDialog", "SwiftX", nullptr));
