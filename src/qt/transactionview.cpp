                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received MRG from zMRG"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMRG"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMRG));
