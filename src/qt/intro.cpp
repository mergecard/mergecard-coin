...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MergeCard Core"),
     ...
     * override -datadir in the mergecard.conf file in the default data directory
     * (to be consistent with mergecardd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
