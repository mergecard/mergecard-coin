...
QT_MOC_LITERAL(6, 86, 31), // "anonymizeMergeCardAmountChanged"
QT_MOC_LITERAL(7, 118, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintPercentageChanged\0"
    "preferredDenomChanged\0"
    "anonymizeMergeCardAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->anonymizeMergeCardAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (OptionsModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::anonymizeMergeCardAmountChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void OptionsModel::anonymizeMergeCardAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
