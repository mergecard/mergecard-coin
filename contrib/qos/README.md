...
This means one can have an always-on mergecardd instance running, and another local mergecardd/mergecard-qt instance which connects to this node and receives blocks from it.
