...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/mergecard-cli.cpp \
           src/mergecard-tx.cpp \
           src/mergecard.cpp \
           src/db.cpp \
           ...
           src/qt/mergecard.cpp \
           src/qt/mergecardstrings.cpp \
...
RESOURCES += src/qt/mergecard.qrc src/qt/mergecard_locale.qrc

TRANSLATIONS += src/qt/locale/mergecard_bg.ts \
                src/qt/locale/mergecard_de.ts \
                src/qt/locale/mergecard_en.ts \
                src/qt/locale/mergecard_es.ts \
                src/qt/locale/mergecard_fi.ts \
                src/qt/locale/mergecard_fr.ts \
                src/qt/locale/mergecard_it.ts \
                src/qt/locale/mergecard_ja.ts \
                src/qt/locale/mergecard_pl.ts \
                src/qt/locale/mergecard_pt.ts \
                src/qt/locale/mergecard_ru.ts \
                src/qt/locale/mergecard_sk.ts \
                src/qt/locale/mergecard_sv.ts \
                src/qt/locale/mergecard_vi.ts \
                src/qt/locale/mergecard_zh_CN.ts \
                src/qt/locale/mergecard_zh_TW.ts
