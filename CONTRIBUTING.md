Contributing to MergeCard Core
============================

The MergeCard Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MergeCard Core project, and is not to be
confused with overall MergeCard Network Protocol consensus changes.

Whether a pull request is merged into MergeCard Core rests with the project merge
...
Patches that change MergeCard consensus rules are considerably more involved than
...
Where a patch set proposes to change the MergeCard consensus, it must have been
...
The project leader is the release manager for each MergeCard Core release.
